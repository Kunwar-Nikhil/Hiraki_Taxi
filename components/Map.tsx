...
import {useDriverStore, userLocationStore} from "../Store/index"
...
if(Array.isArray(drivers)){
  ...
  const newMarkers = generateMarkersFromData({data, userLatitude, userLongitude}:{
    data:drivers,
    userLatitude,
    userLongitude,
  })
  ...
  return (
   ...
   {markers.map((marker)=>(
    ...
    title={marker.title}
    image={selectDriver===marker.id ? icons.selectedMarker || icons.marker}
    />
   ))}
   </MapView>
  );
