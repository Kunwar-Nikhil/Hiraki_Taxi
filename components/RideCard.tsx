...
<Image
source={{
    uri:`https://maps.geoapify.com/v1/staticmap?style=osm-bright&width=600&height=400&center=lonlat:${destination_longitude},${destination_latitude}&zoom=14&apiKey=${GEOAPIFY_API_KEY}`
}}
...
<View className="flex flex-col mx-5 gap-y-5 flex-1 ">
    <View className="flex flex-row items-center gap-x-2">
        ...
        <Text className="text-md font-JakartMedium" numberOfLines={1}> {origin_address}
    ...
    <View className="flex flex-row items-center gap-x-2">
        ...
        <Text className="text-md font-JakartMedium">{origin_address}</Text>
    </View>
</View>

</View>

<View className="flex flex-col w-full mt-5 bg-general-500 rounded-ld p-3 justify-center">
